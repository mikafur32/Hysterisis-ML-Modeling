...
def ingest(csv, target, USGS_FLAG= True, renames={}, train_range= None, test_range= None):
...
def reshape(scaled, timestep_type= 'hr'):
    ...
    for i in range(n_past, len(scaled) - n_future +1):
        ...
        ## NOTE: This assumes the target values are the 1st column after the datetime.
